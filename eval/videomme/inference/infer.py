...
def eval_model(args):
    ...
    dataset = EvalDatasetVMMEBench(args.qa_path, args.video_folder, image_processor,
                                 video_processor, use_subtitles)
    ...
    for (idx, sample_set, video_frames, context_frames, slice_len) in tqdm(dataloader):
        ...
        try:
            ...
            outputs = outputs.strip()
            outputs = outputs.replace(conv.sep, '')
            outputs = outputs.strip()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--video-folder", type=str, default="/ssd1/wxc/video_data/Video_MME/data")
    parser.add_argument("--qa_path", type=str, default="/ssd1/wxc/video_data/Video_MME/test-00000-of-00001.parquet")
